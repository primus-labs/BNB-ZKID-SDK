...
/**
 * Throws {@link import("../errors/prove-error.js").BnbZkIdProveError} `00003` / `Invalid parameters` when
...
/**
 * Validates runtime `ProveInput` and config alignment; throws `00003` with `details.message` / `details.field`.
 */
