...
- [`developer-api.md`](./developer-api.md): external developer integration guide and API reference
- [`error-reference.md`](./error-reference.md): field-by-field error and `details` structure reference
